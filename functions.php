...
function planar_setup() {
	 ...
	 */
	load_theme_textdomain( 'planar', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Header Menu', 'planar' ),
		'top' => __( 'Top Menu', 'planar' ),
		'social' => __( 'Social Menu', 'planar' )
	) );
...
function planar_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Blog Sidebar', 'planar' ),
		'id'            => 'sidebar-blog',
		'description' => __('If empty (no widgets) the layout of posts will be without sidebar.', 'planar'),
	...
	register_sidebar( array(
		'name'          => __( 'Page Sidebar', 'planar' ),
		'id'            => 'sidebar-page',
		'description' => __('If empty (no widgets) the layout of page will be without sidebar.', 'planar'),
		'before_widget' => '<aside id="%1$s" class="widget %2$s clearfix">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h1 class="widget-title">',
		'after_title'   => '</h1>',
	...
	register_sidebar( array(
		'name'          => __( 'Home Page - Before', 'planar' ),
		'id'            => 'front-page-before',
		'description' => __('Widgets area on the Home page before the main content. Use theme widgets (DT).', 'planar'),
	...
	register_sidebar( array(
		'name'          => __( 'Home Page - After', 'planar' ),
		'id'            => 'front-page-after',
		'description' => __('Widgets area on the Home page after the main content. Use theme widgets (DT).', 'planar'),
		'before_widget' => '<section id="%1$s" class="widget-section %2$s clearfix">',
		'after_widget'  => '</section>',
		'before_title'  => '<h1 class="section-title">',
		'after_title'   => '</h1>',
	...
	register_sidebar( array(
		'name' => __('Footer', 'planar'),
		'description' => __('Footer Widget area.', 'planar'),
		'id' => 'footer',
		'before_title' => '<h5>',
		'after_title' => '</h5>',
...
function planar_fonts_url() {
    ...
    */
    $open_sans = _x( 'on', 'Open Sans font: on or off', 'planar' );
...
function planar_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/font-awesome/css/font-awesome.min.css?v=4.2' );//Awesome inc
...
/**
 * Custom customizer control admin style
 */
function planar_custom_customizer_control_style() {
	wp_enqueue_style( 'planar_custom_customizer_control_style', get_template_directory_uri() . '/css/customizer-control.css','1.0' );
}
add_action( 'admin_enqueue_scripts', 'planar_custom_customizer_control_style', 10 );
...
// Enable Shortcodes into widget text
...
require_once( get_template_directory() . '/inc/widgets/widget-page-featured.php' );
require_once( get_template_directory() . '/inc/widgets/widget-posts-home.php' );

/**
 * Custom Widgets when the active plugins
 */
...
function planar_projects_fields( $fields ) {
	$fields['subtitle'] = array(
	    'name' 			=> __( 'Sub Title', 'planar' ),
	    'description' 	=> __( 'Enter a sub title for this project.', 'planar' ),
	    'type' 			=> 'text',
	    'default' 		=> '',
	    'section' 		=> 'info'
	);
	$fields['date'] = array(
	    'name' 			=> __( 'Date', 'planar' ),
	    'description' 	=> __( 'Enter a date for this project.', 'planar' ),
	    'type' 			=> 'text',
	    'default' 		=> '',
	    'section' 		=> 'info'
	);
...
function planar_wooproject_sidebar() {
	register_sidebar(array(
	'name' => __('Project', 'planar' ),
	'description' => __('Located in the sidebar Project', 'planar' ),
	'id' => 'project',
	'before_widget' => '<aside id="%1$s" class="widget %2$s clearfix">',
	'after_widget'  => '</aside>',
	'before_title'  => '<h1 class="widget-title">',
