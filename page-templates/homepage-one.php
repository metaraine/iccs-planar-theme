...
<!-- ChildGrid -->
	...
	<?php if ( $child_pages->have_posts() ) : ?>
		...
		<div class="clearfix" style="background: #<?php echo get_theme_mod( 'background_color','FFF' ); ?>;">
...
<div class="box large childpage" style="background: <?php echo get_theme_mod( 'planar_additional_color','398ece' ); ?>;">
...
$sticky_posts = get_option('sticky_posts');
	...
	<?php if ( is_active_sidebar( 'front-page-after' ) ) { ?>
		<div class="wrap-inner" style="background: #<?php echo get_theme_mod( 'background_color','FFF' ); ?>;">
			<div class="widgets-page-section clearfix">
