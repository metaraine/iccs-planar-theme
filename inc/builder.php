...
function planar_theme_widgets_tab($tabs){
	$tabs[] = array(
		'title' => __('Planar Theme Widgets', 'planar'),
		'filter' => array(
...
function planar_row_styles($fields) {
	...
	$fields['bottom_border'] = array(
		'name' => __('Bottom Border Color', 'planar'),
		'type' => 'color',
		'priority' => 3,		
	);
	$fields['padding'] = array(
		'name' => __('Top/Bottom padding', 'planar'),
		'type' => 'measurement',
		'description' => __('Top and bottom padding for this row / default: 24px', 'planar'),
		'priority' => 4,
	);
	$fields['align'] = array(
		'name' => __('Center align the content?', 'planar'),
		'type' => 'checkbox',
		'description' => __('This may or may not work. It depends on the widget styles.', 'planar'),
		'priority' => 5,
	);		
	$fields['background'] = array(
		'name' => __('Background Color', 'planar'),
		'type' => 'color',
		'description' => __('Background color of the row.', 'planar'),
		'priority' => 6,
	);
	$fields['color'] = array(
		'name' => __('Color', 'planar'),
		'type' => 'color',
		'description' => __('Color of the row.', 'planar'),
		'priority' => 7,
	);	
	$fields['background_image'] = array(
		'name' => __('Background Image', 'planar'),
		'type' => 'image',
		'description' => __('Background image of the row.', 'planar'),
		'priority' => 8,
	);		
	$fields['row_stretch'] = array(
		'name' 		=> __('Row Layout', 'planar'),
		'type' 		=> 'select',
		'options' 	=> array(
			'' 				 => __('Standard', 'planar'),
			'full' 			 => __('Full Width', 'planar'),
			'full-stretched' => __('Full Width Stretched', 'planar'),
		),
		'priority' => 9,
	);
	$fields['mobile_padding'] = array(
		'name' 		  => __('Mobile padding', 'planar'),
		'type' 		  => 'select',
		'description' => __('Here you can select a top/bottom row padding for screen sizes < 1024px', 'planar'),		
		'options' 	  => array(
			'' 				=> __('Default', 'planar'),
			'mob-pad-0' 	=> __('0', 'planar'),
			'mob-pad-15'    => __('15px', 'planar'),
			'mob-pad-30'    => __('30px', 'planar'),
			'mob-pad-45'    => __('45px', 'planar'),
		),
		'priority'    => 10,
	);
	$fields['class'] = array(
		'name' => __('Row Class', 'planar'),
		'type' => 'text',
		'description' => __('Add your own class for this row', 'planar'),
		'priority' => 11,
	);
	$fields['column_padding'] = array(
		'name'        => __('Columns padding', 'planar'),
		'type'        => 'checkbox',
		'description' => __('Remove padding between columns for this row?', 'planar'),
		'priority'    => 12,
	);	
