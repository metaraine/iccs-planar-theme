...
class Planar_Feature_HomeWidgets extends WP_Widget {
	function __construct() {
		parent::__construct(
			...
			'DT ' . __( 'Features  Home Widgets', 'planar' ),
			array(
				'classname' => 'feature_home_widgets', 
				'description' => __( 'Section of Features for Home Page.', 'planar' ),
			)
		);
 	}

 	function form( $instance ) {
		$planar_defaults[ 'title_section' ] = __( 'Features', 'planar' );
 		$planar_defaults[ 'text_main' ] = __( 'The widget for displaying section Features (Woo Features) of the template Home Widgets.', 'planar' );
		...
		<p><?php _e( 'The widget for displaying section Features (Woo Features) of the template Home Widgets.', 'planar' ); ?></p>
