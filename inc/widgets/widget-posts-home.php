...
class Planar_Post_HomeWidgets extends WP_Widget {
	function __construct() {
		parent::__construct(
			'post_home_widgets',
			'DT ' . __( 'Posts  Home Widgets', 'planar' ),
			array(
				'classname' => 'post_home_widgets', 
				'description' => __( 'Section of recent posts on the Home Page.', 'planar' ),
			)
		);
 	}

 	function form( $instance ) {
		$planar_defaults[ 'title_section' ] = __( 'Recent Posts', 'planar' );
 		$planar_defaults[ 'text_main' ] = __( 'The widget for displaying section recent posts on the Home Page.', 'planar' );
		...
		<p><?php _e( 'The widget for displaying section recent posts on the Home Page.', 'planar' ); ?></p>
		...
		<p>
		<label for="<?php echo $this->get_field_id('limit_num'); ?>"><?php _e( 'Number of posts to show:', 'planar' ); ?></label>
