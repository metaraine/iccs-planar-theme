	...
	class TGM_Plugin_Activation {
		...
		protected function add_admin_menu( array $args ) {
			...
			if ( 'themes.php' === $this->parent_slug ) {
				...
				$this->page_hook = call_user_func( 'add_theme_page', $args['parent_slug'], $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] ); // change 'add_submenu_page'
			}
		}
